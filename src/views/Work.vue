...
<template>
  <main class="mw__lg">
    ...
    <section class="left">
      <header>
        <h1 class="mb-2 uc f-xl f-mabry-med">Hi, I’m Matt—a product designer living in Atlanta, Ga.</h1>
        <h2 class="meas-7 f-lg f-travels-med">I’m currently researching design systems &amp; machine learning.</h2>
      </header>
      ...
      <ul>
        ...
        <li>
          <router-link to="/supersymmetry">
            ...
            <h3 class="f-md f-system">A self-initiated project focusing on engineering, buildings, interior desing—basically spaces.</h3>
          </router-link>
        </li>
        ...
        <li>
          <router-link to="/supersymmetry">
            ...
            <h3 class="f-md f-system">A side project about space. Space is cool. And Vast. But mostly cold.</h3>
          </router-link>
        </li>
        ...
        <li>
          <router-link to="/supersymmetry">
            ...
            <h3 class="f-md f-system">I know what you’re thinking, “What about some mobile stuff?” I got you.</h3>
          </router-link>
        </li>
        ...
        <li>
          <router-link to="/supersymmetry">
            ...
            <h3 class="f-md f-system">Some more product work here. Uploading photos is suprisingly tough.</h3>
          </router-link>
        </li>
      </ul>
    </section>
...
<style lang="scss" scoped>
  ...
  .f-xl {
    ...
    @include breakpoint(md) { font-size: 2.7rem; }
  }
