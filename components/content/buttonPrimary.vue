...
<style lang="scss" scoped>
  ...
  button {
    position: relative;
    border-radius: 200px;
    /* border: 1px solid rgba(192, 195, 199, 0.32); */
    background: linear-gradient(180deg, rgba(211, 211, 211, 0.8) 0%, #fff 100%);
    /* box-shadow: 0 0 16px 0 rgba(255, 255, 255, 0.2) inset,
      0 4px 12px 0 rgba(168, 168, 168, 0.28),
      0 1.5px 1px 0 rgba(193, 193, 193, 0.2); */
